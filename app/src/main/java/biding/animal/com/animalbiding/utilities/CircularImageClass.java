...
/**
 * Created by Prabhakant.Agnihotri on 31-10-2017.
 */

public class CircularImageClass extends android.support.v7.widget.AppCompatImageView {
    ...
    public CircularImageClass(final Context context) {
        this(context, null);
    }

    public CircularImageClass(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularImageClass(Context context, AttributeSet attrs, int defStyleAttr) {
